...
import com.tribal.hackathon.tribalhackathon17.Activity.UserArea;
import com.tribal.hackathon.tribalhackathon17.Helper.AppController;
    ...
    private void loginUser(final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                    ...
                    if (success) {
                      //  Log.d("ayush","got response");
                       ...
                       // Log.d("ayush","Events register  "+String.valueOf(count_event_registered));
                        ...
                        Intent i= new Intent(getActivity(),UserArea.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Snackbar.make(getActivity().findViewById(R.id.login), getResources().getString(R.string.Connection_Error), Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                hideDialog();
            }
        }) {
